        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.kamar.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <select name="kost_id" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('kost_id') border-red-500 @enderror">
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        required 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('nomor') border-red-500 @enderror"
                    >
                    @error('nomor')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-500 mt-1">Nomor unik untuk identifikasi kamar</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="tipe_kamar" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('tipe_kamar') border-red-500 @enderror">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            min="0"
                            step="1000"
                            class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('harga') border-red-500 @enderror"
                        >
                    </div>
                    @error('harga')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="mb-8">
                    ...
                    <textarea 
                        name="deskripsi" 
                        rows="4"
                        placeholder="Tambahkan catatan atau deskripsi khusus untuk kamar ini..."
                ...
                <div class="flex items-center justify-between pt-6 border-t">
                    <a href="{{ route('admin.kamar.index') }}" class="px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition font-medium">
                        <i class="fas fa-arrow-left mr-2"></i> Kembali
                    </a>
                    <button type="submit" class="px-8 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-semibold shadow-md">
            ...
            <div class="flex">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <ul class="list-disc list-inside space-y-1">
                        ...
                        <li>Harga diisi dalam format angka tanpa titik atau koma</li>
                        <li>Status kamar dapat diubah sewaktu-waktu dari halaman kelola kamar</li>
                    </ul>
                </div>
            </div>
        </div>
